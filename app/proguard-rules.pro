...
##---------------Begin: proguard configuration for premission  ----------
-dontwarn com.zhy.m.**
-keep class com.zhy.m.** {*;}
-keep interface com.zhy.m.** { *; }
-keep class **$$PermissionProxy { *; }

##---------------End: proguard configuration for premission  ----------

##---------------Start: gradle-retrolambda ----------
-dontwarn java.lang.invoke.*
##---------------End: gradle-retrolambda ----------

##---------------Start: auto scroll viewpager -----------------
-keep class cn.trinea.android.** { *; }
-keepclassmembers class cn.trinea.android.** { *; }
-dontwarn cn.trinea.android.**
##---------------End: auto scroll viewpager -----------------
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class com.lb.duoduo.logic.test.model.http.** { *; }
