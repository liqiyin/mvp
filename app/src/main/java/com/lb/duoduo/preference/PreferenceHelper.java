package com.lb.duoduo.preference;
...
public final class PreferenceHelper {
    ...
    private static final String SETTINGS_FILENAME = SmartApplication.class.getPackage().getName();
    ...
    public static void loadDefaults() {
        ...
        try {
            Map<SmartSettings, Object> defaultPrefs = new HashMap<>();
            SmartSettings[] values = SmartSettings.values();
    ...
    public static SharedPreferences getSharedPreferences() {
        return SmartApplication.getInstance().getSharedPreferences(
                SETTINGS_FILENAME, Context.MODE_PRIVATE);
    }

    public static void savePreference(SmartSettings pref, Object value) throws InvalidClassException {
        Map<SmartSettings, Object> prefs = new HashMap<>();
        prefs.put(pref, value);
        savePreferences(prefs, false);
    }

    public static void savePreferences(Map<SmartSettings, Object> prefs) throws InvalidClassException {

        savePreferences(prefs, false);
    }

    private static void savePreferences(Map<SmartSettings, Object> prefs, boolean noSaveIfExists) throws InvalidClassException {

        SharedPreferences sp = getSharedPreferences();
        SharedPreferences.Editor editor = sp.edit();

        for (SmartSettings pref : prefs.keySet()) {
